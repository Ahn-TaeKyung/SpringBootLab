...
public class PublisherController {
    ...
    public ResponseEntity<PublisherDTO.Response> getPublisherByName(@PathVariable String code) {
        PublisherDTO.Response publisher = publisherService.getPublisherByName(code);
        return ResponseEntity.ok(publisher);
    }
